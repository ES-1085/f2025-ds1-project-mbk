...
``` r
library(readr)
X2024_annual_23001_Androscoggin_County_Maine <- read_csv("../data/Andro.csv")
```

    ## Rows: 1419 Columns: 43
    ## ── Column specification ────────────────────────────────────────────────────────
    ## Delimiter: ","
    ## chr (10): industry_code, qtr, disclosure_code, area_title, own_title, indust...
    ## dbl (33): area_fips, own_code, agglvl_code, size_code, year, annual_avg_esta...
    ## 
